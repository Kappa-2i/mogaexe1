...
public:
  ...
  // Destructor
  virtual ~PostOrderTraversableContainer() specifiers
...
public:
  ...
  // Copy assignment
  InOrderTraversableContainer& operator=(const InOrderTraversableContainer&) = default; // Copy assignment of abstract types is not possible.
