...
public:
  ...
  // Move assignment
  PreOrderMappableContainer& operator=(PreOrderTraversableContainer&&) noexcept = delete; // Move assignment of abstract types is not possible.
...
public:
  ...
  // Move assignment
  BreadthMappableContainer& operator=(const BreadthMappableContainer&) noexcept = delete; // Move assignment of abstract types is not possible.
  ...
  virtual void BreadthMap(argument) specifiers;
