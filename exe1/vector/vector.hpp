...
public:
  ...
  Vector(const TraversableContainer<Data>&) specifiers; // A vector obtained from a TraversableContainer
  Vector(MappableContainer<Data>&&) specifiers; // A vector obtained from a MappableContainer
